ℹ️ This repo was backed up here to illustrate the proposals on the main article, which can be found here: [How to customize your GitHub profile?](https://blog.dev.lawyer/2021/08/cutomize-github.html)<br />
ℹ️ Este repo foi salvo aqui para ilustrar a proposta do artigo que o originou, e que pode ser acessado aqui: [Como personalizar o seu perfil no GitHub?](https://br.dev.lawyer/2021/08/como-personalizar-github.html)
